                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="field-1" placeholder="name" value="{{ $category->name }}" name="name">
                                        @error('name')
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="field-2" placeholder="arabic name" value="{{ $category->ar_name }}" name="ar_name">
                                        @error('ar_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
